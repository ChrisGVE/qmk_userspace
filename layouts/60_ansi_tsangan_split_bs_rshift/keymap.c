// Shared HHKB-style layout (ANSI Tsangan, split backspace + right shift)
#include QMK_KEYBOARD_H

#include "chrisgve.h"

#if defined(KEYCHRON_ENABLE)
  #define LAYOUT_60_ansi_tsangan_split_bs_rshift LAYOUT_ansi_60
#elif !defined(LAYOUT_60_ansi_tsangan_split_bs_rshift)
  #define LAYOUT_60_ansi_tsangan_split_bs_rshift LAYOUT_60_tsangan_hhkb
#endif

// clang-format off
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {

    [_GAMING] = LAYOUT_60_ansi_tsangan_split_bs_rshift(
    ...
    [_QWERTY_MAC] = LAYOUT_60_ansi_tsangan_split_bs_rshift(
        ESC_GLB, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_BSLS, KC_GRV,
        TAB_HYP, KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, BPC_MEH,
    ...
    [_MAC_NAV] = LAYOUT_60_ansi_tsangan_split_bs_rshift(
    ...
    [_QWERTY_LINUX] = LAYOUT_60_ansi_tsangan_split_bs_rshift(
        KC_ESC,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_BSLS, KC_GRV,
        TAB_HYP, KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, BPC_MEH,
    ...
    [_LINUX_NAV] = LAYOUT_60_ansi_tsangan_split_bs_rshift(
        _______, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, _______,
    ...
    [_QWERTY_WIN] = LAYOUT_60_ansi_tsangan_split_bs_rshift(
        KC_ESC,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_BSLS, KC_GRV,
        KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, KC_BSPC,
    ...
    [_WIN_NAV] = LAYOUT_60_ansi_tsangan_split_bs_rshift(
        _______, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, _______,
    ...
    [_NAV_2] = LAYOUT_60_ansi_tsangan_split_bs_rshift(
        _______, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, _______,
    ...
    [_EX_MOUSE] = LAYOUT_60_ansi_tsangan_split_bs_rshift(
