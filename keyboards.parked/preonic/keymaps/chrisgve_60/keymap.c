...
[_LOWER] = LAYOUT_preonic_grid(
  ...
  KC_CAPS, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_QUOT,
  xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx,S(KC_NUHS),S(KC_NUBS),KC_HOME, KC_END, xxxxxxx,
  KC_RCTL, xxxxxxx, KC_RALT, KC_RGUI, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, KC_HOME, KC_PGDN, KC_PGUP, KC_END
),
...
[_RAISE] = LAYOUT_preonic_grid(
  KC_TILD, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_DEL,
  KC_TILD, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_PIPE,
  KC_CAPS, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, KC_DQUO,
  xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, KC_NUHS, KC_NUBS, KC_PGUP, KC_PGDN, xxxxxxx,
  KC_RCTL, xxxxxxx, KC_RALT, KC_RGUI, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, KC_HOME, KC_PGDN, KC_PGUP, KC_END
),
...
[_DIR] = LAYOUT_preonic_grid(
  ...
  xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, FL_DIR,  xxxxxxx, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, xxxxxxx, xxxxxxx,
