...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_QWERTY_MAC] = LAYOUT_tsangan(
		ESC_GLB, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_BSLS, KC_GRV,  KC_PGUP,  KC_NUM,  KC_PSLS, KC_PAST, KC_PMNS,
		TAB_HYP, KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, BPC_MEH,          KC_PGDN,  KC_P7,   KC_P8,   KC_P9,   KC_PPLS,
	...
	[_ADJUST] = LAYOUT_tsangan(
		...
		_______, DF_MAC,  DF_LNX,  DF_WIN,  DF_GMG,  _______, _______, KC_MUTE, _______, _______, WM_DOWN, KC_MPLY,          KC_VOLU,                     _______, _______, _______, _______,
