...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_QWERTY_MAC] =LAYOUT_all(
		...
		KC_LCTL, A_MOUSE, KC_S,    M_NAV,   F_NAV_2, KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,          KC_ENT,                    KC_P4,   KC_P5,   KC_P6,   KC_PPLS,
	...
	[_MAC_NAV] =LAYOUT_all(
		...
		_______, A_SHIFT, S_SHIFT, xxxxxxx, NAV_2,   xxxxxxx, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, xxxxxxx, xxxxxxx,          _______,                   _______, _______, _______, _______,
		_______, xxxxxxx, xxxxxxx, M_DEL,   xxxxxxx, xxxxxxx, M_B_WRD, KC_HOME, KC_PGDN, KC_PGUP, KC_END,  xxxxxxx, _______, _______, _______,          _______, _______, _______, _______,
	...
	[_QWERTY_LINUX] =LAYOUT_all(
		...
		TAB_HYP, KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, KC_BSPC,          KC_PGDN, KC_P7,   KC_P8,   KC_P9,   KC_PPLS,
		KC_LCTL, A_MOUSE, KC_S,    L_NAV,   F_NAV_2, KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,          KC_ENT,                    KC_P4,   KC_P5,   KC_P6,   KC_PPLS,
		SFT_MSE, xxxxxxx, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, R_SHIFT, ADJUST,  KC_UP,            KC_P1,   KC_P2,   KC_P3,   KC_PENT,
	...
	[_LINUX_NAV] =LAYOUT_all(
		...
		_______, A_SHIFT, S_SHIFT, xxxxxxx, NAV_2,   xxxxxxx, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, xxxxxxx, xxxxxxx,          _______,                   _______, _______, _______, _______,
		_______, xxxxxxx, xxxxxxx, L_DEL,   xxxxxxx, xxxxxxx, L_B_WRD, KC_HOME, KC_PGDN, KC_PGUP, KC_END,  xxxxxxx, _______, _______, _______,          _______, _______, _______, _______,
		_______, _______, _______,                   xxxxxxx,                   xxxxxxx, _______, xxxxxxx, _______,          _______, _______, _______, _______, _______, _______
    ),
	...
	[_QWERTY_WIN] =LAYOUT_all(
		...
		KC_ESC,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_BSLS, KC_GRV,  KC_PGUP, KC_NUM,  KC_PSLS, KC_PAST, KC_PMNS,
		KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, KC_BSPC,          KC_PGDN, KC_P7,   KC_P8,   KC_P9,   KC_PPLS,
		KC_LCTL, KC_A,    KC_S,    W_NAV,   F_NAV_2, KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,          KC_ENT,                    KC_P4,   KC_P5,   KC_P6,   KC_PPLS,
	...
	[_WIN_NAV] =LAYOUT_all(
		...
		_______, A_SHIFT, S_SHIFT, xxxxxxx, NAV_2,   xxxxxxx, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, xxxxxxx, xxxxxxx,          _______,                   _______, _______, _______, _______,
		_______, xxxxxxx, xxxxxxx, W_DEL,   xxxxxxx, xxxxxxx, W_B_WRD, KC_HOME, KC_PGDN, KC_PGUP, KC_END,  xxxxxxx, _______, _______, _______,          _______, _______, _______, _______,
		_______, _______, _______,                   xxxxxxx,                   xxxxxxx, _______, xxxxxxx, _______,          _______, _______, _______, _______, _______, _______
    ),
	...
	[_MOUSE] =LAYOUT_all(
		...
		_______, xxxxxxx, MS_ACL2, MS_ACL1, MS_ACL0, MS_BTN2, MS_LEFT, MS_DOWN, MS_UP,   MS_RGHT, xxxxxxx, xxxxxxx,          _______,                   xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx,
		_______, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, MS_WHLL, MS_WHLU, MS_WHLD, MS_WHLR, xxxxxxx, xxxxxxx, KC_RSFT, _______, MS_UP,            xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx,
		_______, _______, _______,                   MS_BTN1,                   xxxxxxx, _______, xxxxxxx, _______,          MS_LEFT, MS_DOWN, MS_RGHT, xxxxxxx, xxxxxxx, xxxxxxx
    ),
	...
	[_EX_MOUSE] =LAYOUT_all(
		...
		KC_HYPR, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, _______,          MS_WHLD, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx,
		_______, xxxxxxx, MS_ACL2, MS_ACL1, MS_ACL0, MS_BTN2, MS_LEFT, MS_DOWN, MS_UP,   MS_RGHT, xxxxxxx, xxxxxxx,          _______,                   xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx,
		TG_MSE,  xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, MS_WHLL, MS_WHLU, MS_WHLD, MS_WHLR, xxxxxxx, xxxxxxx, KC_RSFT, _______, MS_UP,            xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx,
		_______, _______, _______,                   MS_BTN1,                   xxxxxxx, _______, xxxxxxx, _______,          MS_LEFT, MS_DOWN, MS_RGHT, xxxxxxx, xxxxxxx, xxxxxxx
    ),
    // clang-format on
};
