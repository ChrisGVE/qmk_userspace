...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_QWERTY_MAC] = LAYOUT_65_ansi_blocker_split_bs(
        ...
        KC_LCTL, KC_A,    KC_S,    M_NAV,   F_NAV_2, KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,          KC_ENT,           KC_PGDN,
        SFT_MSE, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, R_SHIFT,                   KC_UP,   END_ADJ,
        KC_GLB,  KC_LALT, KC_LGUI,                   SPC_RSE,                            KC_RGUI, KC_RALT,                   KC_LEFT, KC_DOWN, KC_RGHT
    ),

    [_MAC_NAV] = LAYOUT_65_ansi_blocker_split_bs(
    ...
    [_QWERTY_LINUX] = LAYOUT_65_ansi_blocker_split_bs(
        ...
        TAB_HYP, KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, KC_BSPC,          KC_PGUP,
        KC_LCTL, KC_A,    KC_S,    L_NAV,   F_NAV_2, KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,          KC_ENT,           KC_PGDN,
        SFT_MSE, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, R_SHIFT,                   KC_UP,   END_ADJ,
        KC_LCTL, KC_LGUI, KC_LALT,                   SPC_RSE,                            KC_RALT, KC_RGUI,                   KC_LEFT, KC_DOWN, KC_RGHT
    ),

    [_LINUX_NAV] = LAYOUT_65_ansi_blocker_split_bs(
        _______, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, _______,
    ...
    [_WIN_NAV] = LAYOUT_65_ansi_blocker_split_bs(
        _______, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, _______,
    ...
    [_NAV_2] = LAYOUT_65_ansi_blocker_split_bs(
        _______, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, _______,
    ...
    [_RAISE] = LAYOUT_65_ansi_blocker_split_bs(
        _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  xxxxxxx, xxxxxxx, _______,
    ...
    [_ADJUST] = LAYOUT_65_ansi_blocker_split_bs(
        ...
        KC_CAPS, DF_M_P,  DF_L_P,  DF_W_P,  DF_G_P,  KC_GLB,  KC_MPRV, KC_VOLD, KC_VOLU, KC_MNXT, WM_LEFT, WM_RGHT,          _______,          _______,
        _______, DF_MAC,  DF_LNX,  DF_WIN,  DF_GMG,  xxxxxxx, xxxxxxx, KC_MUTE, xxxxxxx, xxxxxxx, WM_DOWN, KC_MPLY,                   KC_VOLU, _______,
        _______, _______, _______,                   KC_MPLY,                            _______, _______,                   KC_MPRV, KC_VOLD, KC_MNXT
    ),

    [_MOUSE] = LAYOUT_65_ansi_blocker_split_bs(
        _______, MS_BTN1, MS_BTN2, MS_BTN3, MS_BTN4, MS_BTN5, MS_BTN6, MS_BTN7, MS_BTN8, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx,
