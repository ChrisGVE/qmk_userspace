...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_MAC_NAV] = LAYOUT_60_tsangan_hhkb(
		...
		xxxxxxx, _______, _______,                            xxxxxxx,                                              _______, _______, _______
    ),
	...
	[_ADJUST] = LAYOUT_60_tsangan_hhkb(
		...
		xxxxxxx, _______, _______,                            KC_MPLY,                                              _______, _______, _______
    ),
	...
	[_MOUSE] = LAYOUT_60_tsangan_hhkb(
		...
		xxxxxxx, _______, _______,                            MS_BTN1,                                              _______, _______, _______
    ),
