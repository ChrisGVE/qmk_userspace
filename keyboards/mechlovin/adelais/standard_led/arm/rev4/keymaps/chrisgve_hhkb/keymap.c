...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_MOUSE] = LAYOUT_alice_split_bs(
     KC_WH_U, _______, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx,         xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, _______,
     KC_WH_D, _______, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx,                  xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, _______,
     _______, _______, xxxxxxx, KC_ACL2, KC_ACL1, KC_ACL0, KC_BTN2,                  KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, xxxxxxx, xxxxxxx, _______,
              _______,          xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx,         xxxxxxx, KC_WH_U, KC_WH_D, xxxxxxx, xxxxxxx, _______, _______, xxxxxxx,
              xxxxxxx,          _______,          KC_BTN1,          _______,                  KC_BTN1,          _______,                            xxxxxxx
    ),
    ...
    [_EX_MOUSE] = LAYOUT_alice_split_bs(
     ...
     KC_WH_D, _______, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx,                  xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, _______,
     _______, _______, xxxxxxx, KC_ACL2, KC_ACL1, KC_ACL0, KC_BTN2,                  KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, xxxxxxx, xxxxxxx, _______,
              TG_MSE,           xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx,         KC_WH_U, KC_WH_D, xxxxxxx, xxxxxxx, xxxxxxx, _______, _______, xxxxxxx,
              xxxxxxx,          _______,          KC_BTN1,          _______,                  KC_BTN1,          _______,                            xxxxxxx
    ),
