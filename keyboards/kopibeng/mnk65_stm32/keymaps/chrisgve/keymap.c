...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_QWERTY_MAC] = LAYOUT_65_ansi_blocker_tsangan_split_bs(
		...
		KC_GLB,  KC_LALT, KC_LGUI,                            KC_SPC,                                      KC_RGUI,          KC_LEFT, KC_DOWN, KC_RGHT
	),
	...
	[_MAC_NAV_1] = LAYOUT_65_ansi_blocker_tsangan_split_bs(
		...
		_______, xxxxxxx, M_F_WRD, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, M_PUT,   xxxxxxx, xxxxxxx, _______,          _______,
	...
	[_LINUX_NAV_1] = LAYOUT_65_ansi_blocker_tsangan_split_bs(
		_______, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, _______, _______,
		_______, xxxxxxx, L_F_WRD, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, L_PUT,   xxxxxxx, xxxxxxx, _______,          _______,
	...
	[_WIN_NAV_1] = LAYOUT_65_ansi_blocker_tsangan_split_bs(
		_______, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, _______, _______,
		_______, xxxxxxx, W_F_WRD, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, W_PUT,   xxxxxxx, xxxxxxx, _______,          _______,
	...
	[_MOUSE] = LAYOUT_65_ansi_blocker_tsangan_split_bs(
		...
		_______,          xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, KC_WH_U, KC_WH_D, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx,          KC_MS_U, _______,
	...
	[_EX_MOUSE] = LAYOUT_65_ansi_blocker_tsangan_split_bs(
		...
		_______, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, _______,          KC_WH_U,
		_______, xxxxxxx, KC_ACL2, KC_ACL1, KC_ACL0, KC_BTN2, KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, xxxxxxx, xxxxxxx,          _______,          KC_WH_D,
		TG_MSE,           xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx, KC_WH_U, KC_WH_D, xxxxxxx, xxxxxxx, xxxxxxx, xxxxxxx,          KC_MS_U, _______,
		_______, _______, _______,                            KC_BTN1,                                     _______,          KC_MS_L, KC_MS_D, KC_MS_R
	),
