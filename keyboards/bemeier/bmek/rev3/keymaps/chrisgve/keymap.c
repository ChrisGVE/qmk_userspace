...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   [_QWERTY_MAC] = LAYOUT_hhkb(
      KC_HOME,  ESC_GLB,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_BSLS, KC_GRV,
      KC_PGUP,  TAB_HYP,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, BPC_MEH,
   ...
   [_ADJUST] = LAYOUT_hhkb(
      ...
      _______,  _______, DF_MAC,  DF_LNX,  DF_WIN,  DF_GMG,  _______,  _______, _______, KC_MUTE, _______, _______, WM_DOWN, KC_MPLY, _______,
