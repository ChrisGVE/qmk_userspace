...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_QWERTY_MAC] = LAYOUT_65_ansi_blocker_tsangan_split_bs(
		...
		TAB_HYP, KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, BPC_MEH,          KC_PGUP,
    ...
    [_MAC_NAV_1] = LAYOUT_65_ansi_blocker_tsangan_split_bs(
		...
		_______,          M_DEL,   _______, _______, _______, M_B_WRD, KC_HOME, KC_END,  _______, _______, _______, _______, _______,          _______,
    ...
    [_LINUX_NAV_1] = LAYOUT_65_ansi_blocker_tsangan_split_bs(
		...
		_______,          L_DEL,   _______, _______, _______, L_B_WRD, KC_HOME, KC_END,  _______, _______, _______, _______, _______,          _______,
		_______, _______, _______,                                     _______,                                     _______, _______, _______, _______
    ),
    ...
    [_WIN_NAV_1] = LAYOUT_65_ansi_blocker_tsangan_split_bs(
		...
		_______,          W_DEL,   _______, _______, _______, W_B_WRD, KC_HOME, KC_END,  _______, _______, _______, _______, _______,          _______,
		_______, _______, _______,                                     _______,                                     _______, _______, _______, _______
    ),
    ...
    [_ADJUST] = LAYOUT_65_ansi_blocker_tsangan_split_bs(
		...
		KC_CAPS, DF_M_P,  DF_L_P,  DF_W_P,  DF_G_P,  KC_GLB,  KC_MPRV, KC_VOLD, KC_VOLU, KC_MNXT, _______, _______,          _______,          _______,
